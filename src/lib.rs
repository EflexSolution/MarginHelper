...
#[derive(Debug)]
pub struct MarginHelperProcessor {
    verbose: bool,
    processed_count: usize,
}

impl MarginHelperProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting MarginHelper processing");
    
    let mut processor = MarginHelperProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = MarginHelperProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = MarginHelperProcessor::new(false);
